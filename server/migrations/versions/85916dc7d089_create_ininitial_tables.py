...
def upgrade():
    ...
    sa.CheckConstraint('isbn >= 1000000000000 AND isbn < 10000000000000', name=op.f('ck_textbooks_check_isbn_length')),
    ...
    sa.ForeignKeyConstraint(['textbook_id'], ['textbooks.id'], name=op.f('fk_posts_textbook_id_textbooks'), ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['post_id'], ['posts.id'], name=op.f('fk_watchlists_post_id_posts')),
    sa.ForeignKeyConstraint(['textbook_id'], ['textbooks.id'], name=op.f('fk_watchlists_textbook_id_textbooks')),
